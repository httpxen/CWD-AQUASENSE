...
<body class="bg-gray-50">
    <div class="min-h-screen flex">
        ...
        <!-- Main Content (walang binago sa header) -->
        <div class="flex-1">
            ...
            <!-- Profile Dropdown Menu (walang binago) -->
    ...
    <!-- Updated Status Modal with Comment Textarea -->
    ...
    <script>
        ...
        // Profile Dropdown (walang binago)
        ...
        // Export Modal functions (walang binago)
