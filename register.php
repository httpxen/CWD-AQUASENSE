...
<head>
  ...
  <style>
    ...
    .form-input {
      ...
      background: linear-gradient(#fff, #fff) padding-box, linear-gradient(to right, #3b82f6, #1d4ed8) border-box;
    }
  ...
  <div class="min-h-screen flex flex-col justify-center py-8 sm:px-6 lg:px-8 relative overflow-hidden">
    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-lg relative z-10 fade-in-up">
      ...
      <div class="card py-7 px-6 shadow-xl rounded-2xl fade-in-up">
        <?php if (!empty($error)): ?>
          <div
            class="mb-6 p-3.5 bg-gradient-to-r from-red-50 to-pink-50 border border-red-200/50 rounded-xl backdrop-blur-sm">
        ...
        <?php if (!empty($_GET['message'])): ?>
          <div
            class="mb-6 p-3.5 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200/50 rounded-xl backdrop-blur-sm">
            <div class="flex items-start">
        ...
        <form class="space-y-5" action="" method="POST" novalidate>
          ...
          <div class="group">
            <label for="username" class="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-4 h-4 text-blue-600 mr-2">
            ...
            <div class="relative">
              <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                  stroke="currentColor"
                  class="w-4 h-4 text-gray-400 group-focus-within:text-blue-600 transition-colors">
                  <path stroke-linecap="round" stroke-linejoin="round"
                    d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                </svg>
              </div>
          ...
          <div class="group">
            ...
            <div class="relative">
              <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 svg-icon text-gray-400" fill="none"
              ...
              <div class="absolute inset-y-0 right-0 pr-3 flex items-center">
                <span id="togglePassword" class="password-toggle text-gray-400 cursor-pointer"
                  onclick="togglePassword()" aria-label="Show password">
                  <svg id="passwordEyeIcon" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none"
          ...
          <div class="group">
            ...
            <div class="relative">
              ...
              <div class="absolute inset-y-0 right-0 pr-3 flex items-center">
                <span id="toggleConfirmPassword" class="password-toggle text-gray-400 cursor-pointer"
                  onclick="toggleConfirmPassword()" aria-label="Show password">
                  <svg id="confirmPasswordEyeIcon" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none"
                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round"
                      d="M3.98 8.223A10.477 10.477 0 0 0 1.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.451 10.451 0 0 1 12 4.5c4.756 0 8.773 3.162 10.065 7.498a10.522 10.522 0 0 1-4.293 5.774M6.228 6.228 3 3m3.228 3.228 3.65 3.65m7.894 7.894L21 21m-3.228-3.228-3.65-3.65m0 0a3 3 0 1 0-4.243-4.243m4.242 4.242L9.88 9.88" />
                  </svg>
            ...
            <div id="passwordError"
              class="hidden w-full mt-2 p-3 bg-gradient-to-r from-red-50 to-pink-50 border border-red-200/50 rounded-xl backdrop-blur-sm transition-all duration-200 ease-in-out opacity-0 translate-y-2">
            ...
            <div class="flex items-start pt-1">
              ...
              <div class="ml-3 flex-1">
                <label for="terms" class="block text-sm text-gray-700 font-medium select-none">
                  I agree to the
                  <button type="button" class="text-blue-600 hover:text-blue-700 underline"
                    onclick="openTermsModal()">Terms and Conditions</button>
                  and
                  <button type="button" class="text-blue-600 hover:text-blue-700 underline"
                    onclick="openPrivacyModal()">Privacy Notice</button>.
                </label>
              </div>
            </div>
            <!-- Terms Error Message Div - Full width, centered content -->
            <div id="termsError"
              class="hidden w-full p-3 bg-gradient-to-r from-red-50 to-pink-50 border border-red-200/50 rounded-xl backdrop-blur-sm transition-all duration-200 ease-in-out opacity-0 translate-y-2">
              <div class="flex items-center justify-center">
                <div class="flex-shrink-0 mr-3">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-5 h-5 text-red-400">
                ...
                <p class="text-sm text-red-800 leading-5 font-medium text-center">Please agree to the Terms and
                  Conditions to continue.</p>
              </div>
            </div>
          </div>
    ...
    <div class="bg-white rounded-2xl shadow-2xl w-11/12 max-w-2xl max-h-[80vh] overflow-hidden">
      ...
      <div class="p-6 overflow-y-auto space-y-4 text-sm">
        ...
        <ol class="list-decimal list-inside space-y-2 text-gray-700">
          ...
          <li><strong>Privacy</strong> – See our <a href="privacy.php" target="_blank"
              class="text-blue-600 underline">Privacy Notice</a>.</li>
      ...
      <div class="px-6 py-4 border-t flex justify-end">
        <button class="px-4 py-2 rounded-lg bg-blue-600 text-white font-semibold" onclick="closeTermsModal()">I
          Understand</button>
      </div>
    </div>
  </div>
  ...
  <div id="privacyModal" class="fixed inset-0 hidden bg-black bg-opacity-40 z-50 items-center justify-center">
    <div class="bg-white rounded-2xl shadow-2xl w-11/12 max-w-2xl max-h-[80vh] overflow-hidden">
      ...
      <div class="p-6 overflow-y-auto space-y-3 text-sm text-gray-700">
        <p>We collect data (complaints, chatbot interactions, usage logs, surveys) to operate & improve AquaSense.
          Rights: access, correct, erase, withdraw consent, lodge complaints.</p>
      ...
      <div class="px-6 py-4 border-t flex justify-end">
        <button class="px-4 py-2 rounded-lg bg-blue-600 text-white font-semibold"
          onclick="closePrivacyModal()">Okay</button>
      </div>
    </div>
  </div>
