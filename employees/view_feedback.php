...
function get_avatar_src($profile_picture, $name) {
    if ($profile_picture) {
        return '../../' . $profile_picture; // Employee folder: 2 levels up
    }
...
<head>
    ...
    <title>View Feedback | CWD AquaSense</title>
            ...
            <div class="flex flex-col h-full">
                <div class="p-6">
                    <div class="flex items-center space-x-3"> 
                        <img src="../../assets/icons/AquaSense.png" alt="Logo" class="w-16 h-16 rounded-lg object-contain bg-white p-1 flex-shrink-0">
                        <div class="flex-1">
